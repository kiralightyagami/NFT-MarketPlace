...
import { KeypairSigner, createSignerFromKeypair, generateSigner, keypairIdentity, percentAmount, publicKey } from '@metaplex-foundation/umi';
import { createUmi } from "@metaplex-foundation/umi-bundle-defaults";
import { ASSOCIATED_TOKEN_PROGRAM_ID, TOKEN_PROGRAM_ID, getOrCreateAssociatedTokenAccount } from "@solana/spl-token";
import { Keypair, LAMPORTS_PER_SOL } from "@solana/web3.js";
import { Marketplace } from "../../programs/marketplace/target/types/marketplace";
...
describe("marketplace", () => {
  ...
  beforeEach(async () => {
    ...
    console.log(`Created NFT Collection: ${collectionMint.publicKey.toString()}`);
  ...
  it("Init Marketplace!", async () => {
    const tx = await program.methods.initializeMarketplace(1)
      ...
      .rpc();
    console.log("Marketplace Init. Tx:", tx);
  });
